...
@Component({
    selector: 'jhi-operino-component',
    templateUrl: './operino-component.component.html'
})
export class OperinoComponentComponent implements OnInit, OnDestroy {
    ...
    loadAll () {
        ...
        this.operinoComponentService.query({
            page: this.page,
            size: this.itemsPerPage,
            sort: this.sort()
        }).subscribe(
